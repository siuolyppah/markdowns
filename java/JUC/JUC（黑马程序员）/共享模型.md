...
- 使用 synchronized 互斥解决临界区的线程安全问题
  ...
  - 掌握 synchronzied 加在成员方法和静态方法上的语法

- 掌握 Object 的 wait/notify 同步方法

- 使用 ReentrantLock 互斥解决临界区的线程安全问题

  掌握 ReentrantLock 的使用细节：可打断、锁超时、公平锁、条件变量

- 掌握 LockSupport 的 park/unpark 方法

  了解可以先unpark，再park仍然有效的机制

> - monitor是JVM的实现（C++)
> - ReentrantLock是在Java层面的实现

- 调用t.jion()，将导致当前线程将在t线程对象的monitor的WaitSet上等待
